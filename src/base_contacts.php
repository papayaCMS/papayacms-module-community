...
* @version $Id: base_contacts.php 39732 2014-04-08 15:34:45Z weinert $
*/
...
class contact_manager extends base_db {
  ...
  */
  public static function getInstance($surferId = '', $max = 3) {
  ...
  */
  ...
  function getContacts(
    ...
    $surfersObj = surfer_admin::getInstance();
  ...
  *
  * @access public
  * @param int $number (optional) -- maximum number of records
  * @param int $offset (optional) -- start record number
  * @param string $surferId (optional)
  * @param string $sort optional 'ASC' OR 'DESC' (default 'ASC')
  * @return array
  */
  function getContactsWithTimestamp(
    $number = NULL, $offset = NULL, $surferId = '', $sort = 'ASC'
  ) {
    if ($surferId == '') {
      $surferId = $this->surfer;
    }
  ...
  * @param NULL|int $number (optional) -- max. number of records
  * @param NULL|int $offset (optional) -- start record
  * @param string $sort optional 'ASC' OR 'DESC' (default 'ASC')
  * @return array
  */
  function getContactRequestsSent(
    $surferId = '', $withTimestamp = FALSE, $number = NULL, $offset = NULL, $sort = 'ASC'
  ) {
    if ($surferId == '') {
      $surferId = $this->surfer;
    }
  ...
  */
  ...
  function traceContact(
    $targetSurfer, $currentSurfer = NULL, $path = NULL, $defaultContact = NULL
  ) {
  ...
  */
  function findContact(
    $contactSurfer, $forceCheck = FALSE, $directOnly = FALSE, $requestDirection = FALSE
  ) {
