...
* @version $Id: connector_surfers.php 39818 2014-05-13 13:15:13Z weinert $
*/
...
* $bool = $surfersObj->verifyPassword($password, $hash)
...
class connector_surfers extends base_connector {
  ...
  */
  function _initSurferAdmin() {
    if (!(isset($this->surferAdmin) && is_object($this->surferAdmin))) {
      $this->surferAdmin = surfer_admin::getInstance();
    }
  }
  ...
  * @return string Surfer handle(s) or empty
  ...
  function getHandleById($id, $order = FALSE, $sort = 'ASC', $includeBlocked = FALSE) {
    $this->_initSurferAdmin();
    return $this->surferAdmin->getHandleById($id, $order, $sort, $includeBlocked);
  }
  ...
  */
   ...
   */
  function loadSurferNames(
    $ids, $sort = 'ASC', $limit = NULL, $offset = NULL, $includeBlocked = FALSE
  ) {
    $this->_initSurferAdmin();
  ...
  * @param integer|NULL $groupId Filter by group id
  * @param integer|NULL $limit Results limit
  * @param integer|NULL $offset Results offset
  * @return array $surfers Surfers data
  */
  function getAllValidSurfers(
    $withHandles = FALSE, $groupId = NULL, $limit = NULL, $offset = NULL
  ) {
    $this->_initSurferAdmin();
  ...
  */
  function loadAllSurfers(
    $limit = NULL,
    $offset = NULL,
    $orderBy = 'surfer_lastmodified',
    $sort = 'DESC',
    $withAbsCount = TRUE,
  ...
  */
   ...
   */
  function searchSurfers(
    $pattern, $handleOnly = FALSE, $includeBlocked = FALSE, $orderBy = 'surfer_handle'
  ) {
    $this->_initSurferAdmin();
  ...
  * @access public
  * @param string|array $surferIds Unique 32-char surfer id(s)
  ...
  */
  function getPasswordHash($password) {
    $this->_initSurferAdmin();
    return $this->surferAdmin->passwordApi()->getPasswordHash($password);
  }
  ...
  */
  function verifyPassword($password, $hash) {
    $this->_initSurferAdmin();
    return $this->surferAdmin->passwordApi()->verifyPassword($password, $hash);
  }
  ...
  *
  * @access public
  * @return array $classes Category classes or empty
  */
  ...
  */
   ...
   *
   * @access public
   * @param string $profileSurferId Unique 32-char surfer id
   * @param string|array|NULL $fields One or more profile data field names
  ...
  * @param NULL|int $limit Set limit for database results
  * @param NULL|int $offset Set offset for database results
  * @param string $sort Sort direction ('ASC' OR 'DESC')
  * @return array $results Contacts data
  */
  function getContacts(
    $surferId, $withTimestamp = FALSE, $limit = NULL, $offset = NULL, $sort = 'ASC'
  ) {
  ...
  * @param NULL|int $limit Set limit for database records
  * @param NULL|int $offset Set offset for database records
  * @param string $sort Sort direction ('ASC' OR 'DESC')
  * @return array $results Contact requests data
  */
  function getContactRequestsSent(
    $surferId, $withTimestamp = FALSE, $limit = NULL, $offset = NULL, $sort = 'ASC'
  ) {
    $contactManager = contact_manager::getInstance($surferId);
  ...
  * @return array $results Contact requests data
  */
  function getContactRequestsReceived(
    $surferId, $withTimestamp = FALSE, $limit = NULL, $offset = NULL, $sort = 'ASC'
  ) {
    $contactManager = contact_manager::getInstance($surferId);
  ...
  */
   ...
   */
  function loadSurfersComplex(
    $filter, $order = NULL, $by = NULL, $limit = NULL, $offset = NULL
  ) {
    $this->_initSurferAdmin();
   ...
   */
  function getLatestRegisteredSurfers(
    $timeOffset = NULL, $number = NULL, $offset = NULL
  ) {
    $this->_initSurferAdmin();
