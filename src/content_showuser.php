...
* @version $Id: content_showuser.php 39600 2014-03-18 11:43:38Z weinert $
*/
    ...
    if ($userId != '') {
      ...
      if (isset($this->params['cmd']) && $this->params['cmd'] == 'mail') {
        if ($this->dialogFeedback->checkDialogInput()) {
          ...
          $from = $surferObj->surfer['surfer_givenname'].' '.
            $surferObj->surfer['surfer_surname'].' <'.
            $surferObj->surfer['surfer_email'].'>';
